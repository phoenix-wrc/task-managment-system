package site.ph0en1x.taskmanagementsystem.web.security;
...
import site.ph0en1x.taskmanagementsystem.web.security.auth.JwtProperties;
import site.ph0en1x.taskmanagementsystem.exception.AccessDeniedException;
...
public class JwtTokenProvider {
    ...
    public JwtResponse refreshUserTokens(String refreshToken) {
        ...
        if (!validateToken(refreshToken)) {
            throw new AccessDeniedException("Token has been expired");
        }
